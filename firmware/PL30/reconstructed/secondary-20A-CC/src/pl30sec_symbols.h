...
/* Additional symbols exercised by the Rev.06 20A CC modification. */
#define SEC_PHASE1                PL30SEC_REG16(0x0428u)
#define SEC_CURRENT_LOOP_MEASURED PL30SEC_REG16(0x0CCAu)
#define SEC_CURRENT_LOOP_TARGET   PL30SEC_REG16(0x0CCCu)
#define SEC_CURRENT_LOOP_PROFILE_BASE PL30SEC_REG16(0x0CCEu)
#define SEC_CC_CLAMP_FAST         PL30SEC_REG16(0x08E0u)
#define SEC_CC_CLAMP_SLOW         PL30SEC_REG16(0x08E2u)
#define SEC_LOOP_FILTER_E50_BIAS  PL30SEC_REG16(0x0E50u)
#define SEC_LOOP_PHASE_FLOOR      PL30SEC_REG16(0x0EA6u)
#define SEC_FAULT_SNAPSHOT_VOUT_WORD PL30SEC_REG16(0x0894u)
#define SEC_FAULT_RECHECK_DELAY   PL30SEC_REG16(0x0E96u)
#define SEC_VOUT_COMMAND_WORD     PL30SEC_REG16(0x0DEEu)
#define SEC_OUTPUT_FREQ_OR_TIMER  PL30SEC_REG16(0x0DF0u)
#define SEC_VOUT_TARGET_COUNTS    PL30SEC_REG16(0x09ECu)


/* Aliases used by the CC20 reconstruction helpers. */
#ifndef SEC_CC_VOUT_PREDICT_894
#define SEC_CC_VOUT_PREDICT_894   PL30SEC_REG16(0x0894u)
#endif
#ifndef SEC_CC_MODE_APPLIED_CCC
#define SEC_CC_MODE_APPLIED_CCC   PL30SEC_REG16(0x0CCCu)
#endif
#ifndef SEC_CC_MODE_A_CCE
#define SEC_CC_MODE_A_CCE         PL30SEC_REG16(0x0CCEu)
#endif
#ifndef SEC_CC_MODE_E50_LIMIT
#define SEC_CC_MODE_E50_LIMIT     PL30SEC_REG16(0x0E50u)
#endif
#ifndef SEC_CC_MODE_EA6_LIMIT
#define SEC_CC_MODE_EA6_LIMIT     PL30SEC_REG16(0x0EA6u)
#endif
