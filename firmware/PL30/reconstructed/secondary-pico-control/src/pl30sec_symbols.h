...
/* PICO/Raspberry Pi external-control patch symbols. */
#define SEC_I2C1_RX_WORD_OR_PAYLOAD       PL30SEC_REG16(0x086Cu)
#define SEC_I2C1_COMMAND_WIRE_REG         PL30SEC_REG8(0x0876u)
#define SEC_PICO_CC_COMMAND_COUNTS        PL30SEC_REG16(0x08C4u)
#define SEC_PICO_STATUS_COMMAND           PL30SEC_REG16(0x08C8u)
#define SEC_PICO_STATUS_COMMAND_H         PL30SEC_REG8(0x08C9u)
...
#define SEC_ADC_CURRENT_RAW_A_OR_SYNTH    PL30SEC_REG16(0x0EAAu)
#define SEC_ADC_CURRENT_RAW_B_OR_SYNTH    PL30SEC_REG16(0x0EACu)

#define SEC_PICO_I2C_LOGICAL_REG_CC       0x1Fu
#define SEC_PICO_I2C_WIRE_REG_CC          0x3Eu
#define SEC_PICO_I2C_LOGICAL_REG_STATUS   0x21u
#define SEC_PICO_I2C_WIRE_REG_STATUS      0x42u
#define SEC_PICO_STATUS_CC_ENABLE         PL30SEC_BIT(0)
#define SEC_PICO_STATUS_OUTPUT_ENABLE     PL30SEC_BIT(15)
#define SEC_PICO_OVP_Q15_SCALE            0x6AC2u
#define SEC_PICO_CC_MIN_COUNTS            0x0500u
#define SEC_PICO_CURRENT_COUNTS_PER_AMP_X10 2650u /* zpsu uses 265.0 counts/A; x10 avoids float in firmware headers. */
