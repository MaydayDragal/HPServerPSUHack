...
- `src/pico_control_patch_points.h` - editable register IDs, scale factors, and bit masks.
- `src/pl30sec_symbols.h` - address-based RAM/SFR symbol map with PICO variables added.
- `analysis/pico_control_patch_summary.md` - concise explanation of the behavior changes.
