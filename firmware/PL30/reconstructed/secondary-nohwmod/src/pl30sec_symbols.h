...
#define SEC_ADC_VBUS_FAST         PL30SEC_REG16(0x0A00u)  /* NoHWMod: scaled ADCBUF2, not raw */
#define SEC_ADC_VBUS_FILTERED     PL30SEC_REG16(0x0A02u)  /* NoHWMod: filtered scaled ADCBUF2 */
